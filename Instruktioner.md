# examinering-Pokemon-Application
Min individuella examinering inom min kurs i frontend 2
...
7. <Pokemon>-komponenten ska visa ut följande data för användarens val av Pokemon:
